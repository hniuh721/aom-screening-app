...
def create_anonymous_questionnaire(
    ...
    db_questionnaire = Questionnaire(
        ...
        has_medical_evaluation=questionnaire_data.has_medical_evaluation,
        attempted_lifestyle_modifications=questionnaire_data.attempted_lifestyle_modifications,
        has_reliable_contraception=questionnaire_data.has_reliable_contraception,
        bariatric_surgery_status=questionnaire_data.bariatric_surgery_status,
        height_ft=questionnaire_data.height_ft,
        height_in=questionnaire_data.height_in,
        weight_lb=questionnaire_data.weight_lb,
        bmi=bmi,
        comorbidities=questionnaire_data.comorbidities,
        symptoms=questionnaire_data.symptoms,
